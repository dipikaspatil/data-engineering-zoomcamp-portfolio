  ...
  create or replace view `de-zoomcamp-2026-486900`.`omnistream_gold`.`stg_aviation`
  OPTIONS()
  as -- Since aviation schemas vary a lot, start with a flexible version. Adjust field names to match table.
