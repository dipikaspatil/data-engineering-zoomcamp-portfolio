  ...
  create or replace view `de-zoomcamp-2026-486900`.`omnistream_gold`.`stg_geo`
  OPTIONS()
  as -- This is a staging model for the 'geo' source data.
-- Purpose:
...
with source as (
    ...
    select *
    from `de-zoomcamp-2026-486900`.`omnistream_staging`.`raw_geo_data`
